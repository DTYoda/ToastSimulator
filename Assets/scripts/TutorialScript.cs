...
public class TutorialScript : MonoBehaviour
{
    ...
    IEnumerator tutorial()
    {
        ...
        yield return new WaitForSeconds(0.4f);
        yield return new WaitUntil(Clicked);
        tutorialText.text = "You'll never be able to solve the toast crisis without finding clues, so make sure to talk to NPCs and complete quests.  (Click to continue)";
        yield return new WaitForSeconds(0.4f);
        yield return new WaitUntil(Clicked);
        tutorialText.text = "I would tell you where to start, but even I have no clue what's causing the toast shortage... Go on and start looking!  (Click to continue)";
        yield return new WaitForSeconds(0.4f);
        yield return new WaitUntil(Clicked);
