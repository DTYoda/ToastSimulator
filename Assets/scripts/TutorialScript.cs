...
public class TutorialScript : MonoBehaviour
{
    ...
    IEnumerator tutorial()
    {
        ...
        yield return new WaitUntil(Clicked);
        tutorialText.text = "First, let's go to the kitchen to see if there's anymore bread left in the house. use WSAD to move, F to open doors, and SHIFT to sprint.";
        Time.timeScale = 1;
        yield return new WaitUntil(questStep1);
        tutorialText.text = "Great! By the way you can press Q to see more details about your current quest. Look! There's still some bread left! Try picking it up by clicking the mouse.";
        ...
        tutorialText.text = "Amazing work. Sadly, there isn't anymore bread, but that's where you come in. The first step to your journy is going outside and touching grass";
        ...
        yield return new WaitUntil(Clicked);
        tutorialText.text = "Any NPC with a blue task marker above their head has a task for you, for example, the neighbor in that purple house, they have a task for you!(Click to continue)";
        yield return new WaitUntil(Clicked);
